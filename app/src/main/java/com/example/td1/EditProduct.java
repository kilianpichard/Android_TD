...
public class EditProduct extends AppCompatActivity {
    ...
    public void editProduct(View view) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL site = new
                            URL("https://dev-restandroid.users.info.unicaen.fr/iut/produits/"+ intent.getStringExtra("id"));
                    ...
                    writer2.println("{\"_id\":1,\"categorie\":null,\"nom\":\""+name.getText().toString()+"\",\"code\":"+code.getText().toString()+"}");
    ...
    public void delProduct(View view) {
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... voids) {
                    try {
                        URL site = new URL("https://dev-restandroid.users.info.unicaen.fr/iut/produits/"+ intent.getStringExtra("id"));
                        HttpURLConnection conn = (HttpURLConnection) site.openConnection();
